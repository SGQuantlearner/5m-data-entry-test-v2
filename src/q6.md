...
**Answer:**  
Prompt B is a better prompt as it is clearly state the role performing the analysis, showing exactly the what and how to present and also clearly stating the audience. This will allow the AI to make a tailored response based on clear requirements.
...
**Reason 1:**  
Steps were given to extract the needed info 

**Reason 2:**  
Role, task, Data, Steps are explicitly given with no ambuigity.
...
Identify age groups and products with the lowest satisfaction scores,  present it in graphic for ease of consumption
Extract the most common themes from the written comments.
Summarise findings in an executive summary paragraph - keep the paragraph to keys points

**What you borrowed and why:**  
Not exactly borrow but explicitly indicate how I want it to be presented.
